...
export function MoveBorderColor({
    ...
    >
      ...
      >
        <MovingBorder duration={duration} rx="30%" ry="30%">
          <div
            className={clsx(
              "h-20 w-20 opacity-[0.8] bg-[radial-gradient(#c288d3_40%,transparent_60%)]",
              borderClassName,
            )}
          />
        </MovingBorder>
    ...
    <>
      ...
      <motion.div
        style={{
          ...
          transform,
          background: "radial-gradient(circle, #c288d3 50%, transparent 80%)", // Set red color here
          width: "30%",
          height: "20%",
        }}
      >
